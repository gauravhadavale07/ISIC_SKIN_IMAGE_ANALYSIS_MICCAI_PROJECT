...
try:
    progress_path = os.path.join(cfg.paths.summaries_dir, "experiment_progress.json")
    with open(progress_path) as f:
        progress = json.load(f)
except FileNotFoundError:
    print(f"Error: experiment progress summary not found at {progress_path}.")
    sys.exit(1)
...
temp_csv = os.path.join(cfg.paths.results_dir, "pad_ufes_20_lexical_control.csv")
...
out_json = os.path.join(cfg.paths.results_dir, "lexical_control_results.json")
