...
# Load included summary results to avoid re-running expensive mechanistic probes.
EXISTING_JSON = os.path.join(cfg.paths.summaries_dir, "milk10k_clean_audit_results.json")
existing_data = {}
...
for arch_name, (model_cls, prefix) in MODELS.items():
    ...
    for seed in SEEDS:
        ...
        # Raw prediction caches are intentionally not written by default in the
...
OUT_JSON = os.path.join(cfg.paths.results_dir, "milk10k_clean_audit_results.json")
