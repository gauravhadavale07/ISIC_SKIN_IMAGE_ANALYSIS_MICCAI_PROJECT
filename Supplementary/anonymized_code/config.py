...
class PathConfig:
    ...
    package_root: ClassVar[Path] = Path(__file__).resolve().parent.parent

    milk10k_csv: str = str(package_root / "data_splits" / "milk10k_train.csv")
    milk10k_img_dir: str = str(package_root / "data" / "raw_milk10k")
    pad_ufes_csv: str = str(package_root / "data_splits" / "pad_ufes_20_test.csv")
    pad_ufes_img_dir: str = str(package_root / "data" / "raw_pad_ufes")

    checkpoint_dir: str = str(package_root / "checkpoints")
    results_dir: str = str(package_root / "outputs")
    summaries_dir: str = str(package_root / "result_summaries")
    extended_tables_dir: str = str(package_root / "extended_tables")
