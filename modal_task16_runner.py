...
app = modal.App("miccai-task16-lvlm-steering")
...
@app.function(
    gpu="H100", # Using H100 (closest to H200) for maximum compute on the 7B parameter LLaVA-Med model
    image=image,
    timeout=3600,
    volumes={
...
def run_task16():
    print("\n==================================================")
    print("Running task16_lvlm_steering.py...")
    print("==================================================\n")
    subprocess.run(["python3", "task16_lvlm_steering.py"], check=True)
    vol_results.commit()
