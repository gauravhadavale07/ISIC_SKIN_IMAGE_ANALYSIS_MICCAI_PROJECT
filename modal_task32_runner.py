...
app = modal.App("miccai-task32-multimodal-sae-audit")
...
def run_task32():
    print("\n==================================================")
    print("Running task32_multimodal_sae_audit.py...")
    print("==================================================\n")
    subprocess.run(["python3", "task32_multimodal_sae_audit.py", "--seed", "1337"], check=True)
    print("\n==================================================")
    print("Running task32_multimodal_sae_audit.py (Seed 42)...")
    print("==================================================\n")
    subprocess.run(["python3", "task32_multimodal_sae_audit.py", "--seed", "42"], check=True)
    vol_results.commit()
