...
app = modal.App("miccai-task21-matched-grounding")
...
def run_task21():
    print("\n==================================================")
    print("Running task21_matched_grounding_audit.py on Modal H100...")
    print("==================================================\n")
    subprocess.run(["python3", "-u", "task21_matched_grounding_audit.py"], check=True)
    vol_results.commit()
