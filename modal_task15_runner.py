...
app = modal.App("miccai-task15-ddi")
...
image = modal.Image.debian_slim().pip_install(
    ...
    "/home/ec2-user/ISIC_SKIN_IMAGE_ANALYSIS_MICCAI_PROJECT/data/ddi",
    remote_path="/root/project/data/ddi",
).add_local_dir(
...
def run_task15():
    print("\n==================================================")
    print("Running task15_ddi_demographic_patching.py...")
    print("==================================================\n")
    subprocess.run(["python3", "task15_ddi_demographic_patching.py"], check=True)
    vol_results.commit()
