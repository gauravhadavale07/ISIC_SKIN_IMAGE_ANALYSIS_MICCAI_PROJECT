...
app = modal.App("miccai-task34-das-steering")
...
def run_task34():
    print("\n==================================================")
    print("Running task34_dynamic_activation_steering.py...")
    print("==================================================\n")
    subprocess.run(["python3", "-u", "task34_dynamic_activation_steering.py"], check=True)
    vol_results.commit()
